...
╭────[ **🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅**]────⍟
│
├🔸🤖 **My Name:** [Public 𝐅𝐢𝐥𝐞 𝐒𝐭𝐨𝐫𝐞 𝐁𝐨𝐭](https://t.me/{BOT_USERNAME})
│
...
│
├🔸👨‍💻 **Developer:** [@Z_Harbour_bot](https://t.me/Z_Harbour_bot) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭 MY Father's Channel](https://t.me/I_AM_Groot_S1_Andor_S1_HD)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/I_AM_Groot_S1_Andor_S1_HD)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_ME_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@Z_Harbour_bot](https://t.me/Z_Harbour_bot) 
